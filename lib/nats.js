...
Client.prototype.setupHandlers = function () {
  ...
  // ensure the timeout option is used and another connection timeout isn't already set
  ...
  const streamRef = this.stream // must be kept as this.stream will be destroyed for detecting previous data
  ...
  this.stream.on('error', (exception) => {
